...
Целью данного миксера, является автоматизированное изготовление порций удобрений с индивидуальной рецептурой для гидропоники на необходимое количество (объем) рабочего раствора.
